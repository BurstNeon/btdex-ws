    ...
    convertBidArray(trans) {
        ...
        for (var i = 0; i < trans.openOrders.length; i++) {
            if (trans.openOrders[i].asset == "12402415494995249540") {
                ...
                this.state.series[0].data.push((parseFloat(trans.openOrders[i].quantityQNT / 10000)).toFixed(2))
    ...
    convertAskArray(trans) {
        ...
        for (var i = 0; i < trans.openOrders.length; i++) {
            if (trans.openOrders[i].asset == "12402415494995249540") {
                ...
                this.state.series2[0].data.push((parseFloat(trans.openOrders[i].quantityQNT / 10000)).toFixed(2))
            }
    ...
    render() {
        ...
        return (
            ...
            this.state.sellTrans.length > 0 && ( <
                ...
                <
                Card.Header > < b id = "acc" > < button id = "ac"
                onClick = {
                    this.onCloseModal2
                } > < img src = "https://img.icons8.com/material/25/000000/close-window--v1.png" / > < /button></b > < b id = "accs" > < img src = "https://img.icons8.com/ios/30/000000/blockchain-technology.png" / > HISTORIC TRADES < /b> </Card.Header >
                <
                Card.Body >
                <
                Table id = ""
                ...
                tbody > {
                    this.state.accountTrades.map(p => ( <
                        ...
                        td > {
                            this.convertTimestamp(p.timestamp)
                        } < /td> <
                        td > {
                            parseFloat(p.priceNQT / 10000).toFixed(5)
                        } < /td> <
                        td > {
                            parseFloat(p.quantityQNT / 10000).toFixed(2)
                        } < /td> <
                        td > {
                            p.height
                        } < /td> <
                        td > {
                            parseFloat((p.quantityQNT / 10000 * p.priceNQT) / 10000).toFixed(2)
                        } < /td>
                ...
                /Table> <
                /Card.Body> <
                Card.Footer className = "text-muted" > < Spinner size = "sm"
                animation = "grow"
                variant = "primary" / > {
                    this.state.updateDate !== '' ? "Last Updated: " + this.state.updateDate : ""
                } < /Card.Footer> <
                /Card>
                ...
                onClick = {
                    this.onCloseModal3
                } > < img src = "https://img.icons8.com/material/25/000000/close-window--v1.png" / > < /button></b > < b id = "accs" > < img src = "https://img.icons8.com/ios/30/000000/blockchain-technology.png" / > SELL ACTIVITY < /b> </Card.Header >
                <
                Card.Body >
                <
                Table id = ""
                ...
                onClick = {
                    this.onCloseModal4
                } > < img src = "https://img.icons8.com/material/25/000000/close-window--v1.png" / > < /button></b > < b id = "accs" > < img src = "https://img.icons8.com/ios/30/000000/blockchain-technology.png" / > BUY ACTIVITY < /b> </Card.Header >
                <
                Card.Body >
                <
                Table id = ""
                ...
                onClick = {
                    this.onCloseModal
                } > < img src = "https://img.icons8.com/material/25/000000/close-window--v1.png" / > < /button></b > < b id = "accs" > < img src = "https://img.icons8.com/ios/30/000000/blockchain-technology.png" / > BTDEX SETTINGS < /b> </Card.Header >
                <
                Card.Body >
                ...
                id = "accountCheck"
                variant = "outline-secondary" > Add Wallet < /Button> <
                /InputGroup.Append> <
                /InputGroup> <
                /td> <
                /tr> <
                ...
                id = "accountCheck"
                variant = "outline-secondary" > Check Node < /Button></td >
                <
                /tr> <
                tr >
                <
                ...
                id = "accountCheck"
                variant = "outline-secondary" > Clear Data < /Button></td >
                <
                /tr> <
                /tbody> <
                /Table>
                ...
                Card.Footer className = "text-muted" > < Spinner size = "sm"
                animation = "grow"
                variant = "primary" / > Fetch Data from Blockchain {
                    this.state.updateDate !== '' ? "- Updated: " + this.state.updateDate : ""
                } < /Card.Footer> <
                /Card>
                ...
                variant = "light" >
                <
                img src = "https://btdex.trade/assets/images/icon-130x128.png"
                width = "45"
                height = "40"
                alt = "BTDEX" / >
                <
                Navbar.Brand href = "" > < b > & nbsp; BTDEX < /b></Navbar.Brand >
                <
                Nav className = "mr-auto"
                style = {
                    {
                        visibility: this.state.hideTag
                    }
                } >
                <
                NavDropdown title = < b id = "ids" > < img src = "https://img.icons8.com/color/25/000000/expeditedssl.png" / > {
                    this.state.reci
                } < /b> id="nav-dropdown"> <
                NavDropdown.Item eventKey = "4.1" > < b > Balance < /b> </NavDropdown.Item >
                <
                NavDropdown.Item eventKey = "4.1" > < img id = "settBalance"
                src = "https://img.icons8.com/dotty/20/000000/coins.png" / > {
                    this.state.accountBalance
                }
                TRT < /NavDropdown.Item> <
                NavDropdown.Divider / >
                <
                NavDropdown.Item onClick = {
                    this.onOpenModal2
                }
                eventKey = "4.1" > All Trades < /NavDropdown.Item> <
                NavDropdown.Item onClick = {
                    this.onOpenModal4
                }
                eventKey = "4.2" > All Buy Orders < /NavDropdown.Item> <
                NavDropdown.Item onClick = {
                    this.onOpenModal3
                }
                eventKey = "4.3" > All Sell Orders < /NavDropdown.Item> <
                NavDropdown.Divider / >
                <
                NavDropdown.Item onClick = {
                    this.removeReci
                }
                ventKey = "4.4" > Remove Account < /NavDropdown.Item> <
                /NavDropdown> <
                /Nav> <
                Nav >
                <
                ...
                disabled > ETC / BURST < /NavDropdown.Item> <
                NavDropdown.Item eventKey = "4.2"
                disabled > BTC / BURST < /NavDropdown.Item> <
                NavDropdown.Item eventKey = "4.1"
                disabled > LTC / BURST < /NavDropdown.Item> <
                NavDropdown.Item eventKey = "4.2"
                disabled > XMR / BURST < /NavDropdown.Item> <
                /NavDropdown> <
                Nav.Link onClick = {
                    this.onOpenModal
                }
                href = "#deets" > < img src = "https://img.icons8.com/pastel-glyph/20/000000/purchase-order.png" / > < b id = "sett" > BTDEX SETTINGS < /b></Nav.Link >
                ...
                Card >
                <
                div id = "headBuy" > Buy Order Activity < /div> <
                ...
                Col >
                <
                Card > < div id = "headBuy" > Sell Order Activity < /div> <
                div className = "mixed-chart" >
                <
                Chart options = {
                    this.state.options
                ...
                for the btdex.All information is without guarantee and permanent correctness is not guaranteed.The distribution of the software is under gnu v3 license. <
                /p> <
                /div> <
                ...
                /p>
                Support the project with a donation to BURST - 2 QQ5 - 6477 - ZFK5 - BQCH4 <
                /div> <
                ...
                href = "https://discordapp.com/invite/VQ6sFAY" > < i className = "fa fa-discord" / > < /a></li >
                <
                li > < a className = "twitter"
                href = "https://twitter.com/btdex_trade" > < i className = "fa fa-twitter" / > < /a></li >
                <
                /ul> <
                /div> <
                /div> <
