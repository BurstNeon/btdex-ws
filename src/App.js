...
class App extends React.Component {
  ...
  getAllAccountTrades() {
    if (this.state.reci !== "") {
      fetch(
        `${apiPoint}/burst?requestType=getTrades&account=${this.state.reci}`
      )
        .then(res => res.json())
        .then(
          result => {
  ...
  getAllAccountBalance() {
    if (this.state.reci !== "") {
      fetch(
        `${apiPoint}/burst?requestType=getAssetAccounts&asset=12402415494995249540`
      )
        .then(res => res.json())
        .then(
          result => {
            this.state.accountBalance = this.convertAccountBalance(
              result,
              this.state.reci
            );
          },
  ...
  convertAccountSells(trans) {
    ...
    for (var i = 0; i < trans.trades.length; i++) {
      if (
        trans.trades[i].asset == "12402415494995249540" &&
        trans.trades[i].tradeType == "sell"
      ) {
        transData.push(trans.trades[i]);
      }
    }
  ...
  convertAccountBalance(trans, reci) {
    ...
    for (var i = 0; i < trans.accountAssets.length; i++) {
      if (
        trans.accountAssets[i].asset == "12402415494995249540" &&
        trans.accountAssets[i].accountRS == reci
      ) {
  ...
  removeReci() {
    ...
    document.getElementsByClassName("dropdown nav-item")[0].style.display =
      "none";
  }
  ...
  setReci() {
    ...
    document.getElementsByClassName("dropdown nav-item")[0].style.display =
      "block";
    document.getElementsByClassName("dropdown nav-item")[0].style.visibility =
      "visible";
      ...
      .then(
        result => {
          if (result.errorCode == 5 || result.errorCode == 3) {
            ...
            document.getElementById("reci").style.border =
              "3px solid #b7637f94";
  ...
  convertBidArray(trans) {
    ...
    for (var i = 0; i < trans.openOrders.length; i++) {
      if (trans.openOrders[i].asset == "12402415494995249540") {
        ...
        total =
          total +
          parseFloat(trans.openOrders[i].quantityQNT / 10000) *
            parseFloat(trans.openOrders[i].priceNQT / 10000);
        this.totalBuy = total.toFixed(2);

        this.state.series[0].data.push(
          parseFloat(trans.openOrders[i].quantityQNT / 10000).toFixed(2)
        );
  ...
  convertAskArray(trans) {
    ...
    for (var i = 0; i < trans.openOrders.length; i++) {
      if (trans.openOrders[i].asset == "12402415494995249540") {
        ...
        this.state.series2[0].data.push(
          parseFloat(trans.openOrders[i].quantityQNT / 10000).toFixed(2)
        );
      }
    }
      ...
      this.state.sellTrans.length > 0 && (
        <div>
            ...
            <Card id="orders">
              <Card className="text-center">
                <Card.Header>
                  <b id="acc">
                    {" "}
                    <button id="ac" onClick={this.onCloseModal2}>
                      {" "}
                      <img src="https://img.icons8.com/material/25/000000/close-window--v1.png" />{" "}
                    </button>
                  </b>{" "}
                  <b id="accs">
                    {" "}
                    <img src="https://img.icons8.com/ios/30/000000/blockchain-technology.png" />{" "}
                    HISTORIC TRADES
                  </b>{" "}
                </Card.Header>
                <Card.Body>
                    ...
                    <tbody>
                      {this.state.accountTrades.map(p => (
                        <tr>
                          ...
                          <td>
                            {parseFloat(
                              ((p.quantityQNT / 10000) * p.priceNQT) / 10000
                            ).toFixed(2)}
                          </td>
                        </tr>
                      ))}
                ...
                <Card.Footer className="text-muted">
                  ...
                  {this.state.updateDate !== ""
                    ? "Last Updated: " + this.state.updateDate
                    : ""}
                </Card.Footer>
              </Card>
            </Card>
            ...
            <Card id="orders">
              <Card className="text-center">
                <Card.Header>
                  <b id="acc">
                    {" "}
                    <button id="ac" onClick={this.onCloseModal3}>
                      {" "}
                      <img src="https://img.icons8.com/material/25/000000/close-window--v1.png" />{" "}
                    </button>
                  </b>{" "}
            ...
            <Card id="orders">
              <Card className="text-center">
                <Card.Header>
                  <b id="acc">
                    {" "}
                    <button id="ac" onClick={this.onCloseModal4}>
                      {" "}
                      <img src="https://img.icons8.com/material/25/000000/close-window--v1.png" />{" "}
                    </button>
                  </b>{" "}
            ...
            <Card id="orders">
              <Card className="text-center">
                <Card.Header>
                  <b id="acc">
                    {" "}
                    <button id="ac" onClick={this.onCloseModal}>
                      {" "}
                      <img src="https://img.icons8.com/material/25/000000/close-window--v1.png" />{" "}
                    </button>
                  </b>{" "}
          ...
          <Navbar bg="light" variant="light">
            <img
              src="https://btdex.trade/assets/images/icon-130x128.png"
              width="45"
              height="40"
              alt="BTDEX"
            />
            ...
            <Nav className="mr-auto" style={{ visibility: this.state.hideTag }}>
              <NavDropdown
                title=<b id="ids">
                  <img src="https://img.icons8.com/color/25/000000/expeditedssl.png" />
                  {this.state.reci}
                </b>
                id="nav-dropdown"
              >
                ...
                <NavDropdown.Item eventKey="4.1">
                  ...
                  />{" "}
                  {this.state.accountBalance} TRT
                </NavDropdown.Item>
                <NavDropdown.Divider />
                <NavDropdown.Item onClick={this.onOpenModal2} eventKey="4.1">
                  All Trades
                </NavDropdown.Item>
                <NavDropdown.Item onClick={this.onOpenModal4} eventKey="4.2">
                  All Buy Orders
                </NavDropdown.Item>
                <NavDropdown.Item onClick={this.onOpenModal3} eventKey="4.3">
                  All Sell Orders
                </NavDropdown.Item>
                <NavDropdown.Divider />
                <NavDropdown.Item onClick={this.removeReci} ventKey="4.4">
                  Remove Account
                </NavDropdown.Item>
              </NavDropdown>
            </Nav>
            <Nav>
              <NavDropdown
                title=<b id="ids">
                  <img src="https://img.icons8.com/dotty/25/000000/bank-card-back-side.png" />
                  TRT/BURST MARKET
                </b>
                id="nav-dropdown"
              >
              ...
              <Nav.Link onClick={this.onOpenModal} href="#deets">
                <img src="https://img.icons8.com/pastel-glyph/20/000000/purchase-order.png" />
                <b id="sett">BTDEX SETTINGS</b>
              </Nav.Link>
            </Nav>
            <Form inline>
              <FormControl
          ...
          <Row>
            ...
            <Col>
              <Card>
                {" "}
                <div id="headBuy"> Sell Order Activity </div>
                <div className="mixed-chart">
                  <Chart
                    options={this.state.options}
              ...
              <Card id="noBorder">
                <div class="ExTit">
                  ...
                  <div class="info">
                    <div class="desc"></div>
                    <div class="details">
                      <div class="num" id="smallEx">
                        Total <b>{this.totalBuy} </b> Burst
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <Card id="noBorder">
                <div class="ExTit">
                  ...
                  <div class="info">
                    ...
                    <div class="details">
                      <div class="num" id="smallEx">
                        Total <b>{this.totalSell} </b> Burst
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="row">
                <div className="col-sm-12 col-md-6">
                  ...
                  <p className="text-justify">
                    This is the web version for the btdex. All information is
                    without guarantee and permanent correctness is not
                    guaranteed. The distribution of the software is under gnu v3
                    license.
                  </p>
                </div>
                <div className="col-xs-6 col-md-3">
                  ...
                  <ul className="footer-links">
                    <li>
                      <a href="https://btdex.trade/BTDEXandTRT.pdf">
                        BTDEX Whitepaper
                      </a>
                    </li>
                    <li>
                      <a href=" https://github.com/btdex/btdex/releases/">
                        BTDEX Desktop Client
                      </a>
                    </li>
                  </ul>
                </div>
                <div className="col-xs-6 col-md-3">
                  ...
                  <ul className="footer-links">
                    <li>
                      <a href="https://btdex.trade/">BTDEX Website</a>
                    </li>
                    <li>
                      <a href="https://github.com/btdex/btdex">
                        BTDEX Software
                      </a>
                    </li>
                  </ul>
              ...
              <div className="row">
                <div className="col-md-8 col-sm-6 col-xs-12">
                  <p className="copyright-text">
                    Copyright © {new Date().getYear() + 1900} All Rights
                    Reserved by
                    <a href="https://github.com/BurstNeon"> TWBN</a>.
                  </p>
                  Support the project with a donation to
                  BURST-2QQ5-6477-ZFK5-BQCH4
                </div>
                <div className="col-md-4 col-sm-6 col-xs-12">
                  <ul className="social-icons">
                    <li>
                      <a
                        className="facebook"
                        href="https://discordapp.com/invite/VQ6sFAY"
                      >
                    ...
                    <li>
                      <a
                        className="twitter"
                        href="https://twitter.com/btdex_trade"
                      >
